...
class WebAnnoyanceShort(core.app_scenario.Scenario):
    default_params.run()
    ...
    def setUp(self):
        machine_profiles.apply_to_mute("web_annoyance_short")
        ensure_pictures_fixture(self)

        actions_json = os.path.join(os.path.dirname(__file__), "web_annoyance_short.json")
