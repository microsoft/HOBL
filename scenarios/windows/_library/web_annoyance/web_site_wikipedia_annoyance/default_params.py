...
def run():
    ...
    run_user_only()
    Params.setDefault('web_site_wikipedia_annoyance', 'new_tab', '0', desc='', valOptions=['0', '1'])
    Params.setDefault('web_site_wikipedia_annoyance', 'load_only', '0', desc='', valOptions=['0', '1'])
    Params.setDefault('web_site_wikipedia_annoyance', 'web_site_load_time', '15', desc='', valOptions=[])
    return
